# Problem 4: Cellular Automaton (Game of Life)
...
The next state is created by applying the above rules simultaneously to every cell in the current state. Given the current state of the grid board, return the next state. Do it in-place.

## Input Format
- A 2D integer matrix `board`.
